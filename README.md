...
Scalable computational workflows for transcriptomics, epigenomics, single-cell analysis, and integrative biomarker discovery.

### Cloud-Native Bioinformatics
Production-grade, reproducible NGS and computational biology pipelines using containers, workflow orchestration, and cloud infrastructure.

### Biomedical AI Agents
Agentic systems for scientific reasoning, biomedical document analysis, workflow automation, and knowledge retrieval.
